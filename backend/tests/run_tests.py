...
def main():
    ...
    parser.add_argument(
        "--no-coverage", action="store_true", help="Desabilita relatório de cobertura"
    )
    parser.add_argument(
        "--html", action="store_true", help="Gera relatório HTML de cobertura"
    )
    parser.add_argument("--verbose", "-v", action="store_true", help="Execução verbosa")
    parser.add_argument(
        "--fast",
        action="store_true",
