...
class HierarchyService:
    ...
    def promote_to_admin(
        self, master_user: User, target_user: User, reason: str = None
    ) -> User:
        """
        ...
        AuditService.log_user_action(
            ...
            details={"from_role": "USER", "to_role": "ADMIN", "reason": reason},
        )
    ...
    def demote_to_user(
        ...
        AuditService.log_user_action(
            ...
            details={"from_role": "ADMIN", "to_role": "USER", "reason": reason},
        )
    ...
    def toggle_admin_visibility(
        self, master_user: User, target_admin: User, can_view: bool
    ) -> User:
        """
        ...
        AuditService.log_user_action(
            ...
            details={"can_view_admins": can_view},
        )
    ...
    def block_user(
        self, manager_user: User, target_user: User, reason: str = None
    ) -> User:
        """
        Bloqueia um usuário.
