...
class EmailService:
    ...
    def send_temporary_password_email(self, to_email: str, user_name: str, temp_password: str) -> bool:
    ...
    def send_password_reset_notification(self, to_email: str, user_name: str, admin_name: str) -> bool:
