      ...
      <ToastProvider>
        <Router>
          <div className="min-h-screen bg-gray-100">
            ...
            <Route path="/admin/audit-logs" element={<AdminRoute element={<AuditLogsPage />} />} />
            <Route path="/admin/reports" element={<AdminRoute element={<AdminReportsPage />} />} />
            <Route path="/admin/system-config" element={<MasterRoute element={<SystemConfigPage />} />} />
