...
describe('EntryService', () => {
  ...
  describe('getAll', () => {
    it('deve buscar todas as entradas sem filtros', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/entries', { params: undefined });
  ...
  describe('create', () => {
    ...
    it('deve tratar erro de validação ao criar entrada', async () => {
      ...
      await expect(entryService.create({ ...newEntryData, amount: -10 }))
    ...
    it('deve tratar erro de categoria não encontrada', async () => {
      ...
      await expect(entryService.create({ ...newEntryData, category_id: 'invalid' }))
        .rejects.toEqual(mockError);
    });
  });
  ...
  describe('update', () => {
    ...
    it('deve tratar erro quando entrada não encontrada para atualização', async () => {
      ...
      await expect(entryService.update('999', updateData))
        .rejects.toEqual(mockError);
    });
    ...
    it('deve tratar erro de validação na atualização', async () => {
      ...
      await expect(entryService.update('1', { date: 'invalid-date' }))
        .rejects.toEqual(mockError);
    });
  });
  ...
  describe('getSummary', () => {
    it('deve buscar resumo sem filtros', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/entries/summary', { params: undefined });
  ...
  describe('getMonthlySummary', () => {
    it('deve buscar resumo mensal', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/entries/summary/monthly/2024/1');
    ...
    it('deve buscar resumo mensal para diferentes meses', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/entries/summary/monthly/2024/2');
    ...
    it('deve buscar resumo mensal para diferentes anos', async () => {
      ...
      expect(mockApi.get).toHaveBeenCalledWith('/entries/summary/monthly/2025/1');
    ...
    it('deve tratar erro ao buscar resumo mensal', async () => {
      ...
      await expect(entryService.getMonthlySummary(2024, 13))
        .rejects.toEqual(mockError);
    });
    ...
    it('deve tratar erro de servidor ao buscar resumo mensal', async () => {
      ...
      await expect(entryService.getMonthlySummary(2024, 1))
        .rejects.toEqual(mockError);
    });
  });
  ...
  describe('integração entre métodos', () => {
    ...
    it('deve atualizar e buscar entrada', async () => {
      const updateData = { amount: 250.00, description: 'Updated Integration Entry' };
      const updatedEntry = { ...mockEntry, ...updateData };
