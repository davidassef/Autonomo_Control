...
describe('API Service', () => {
  ...
  describe('Request Interceptor', () => {
    ...
    it('deve adicionar token de autorização quando disponível', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('🔧 API Request: Token adicionado ao header');
    });
    ...
    it('deve funcionar sem token', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('🔧 API Request: Nenhum token encontrado');
    });
    ...
    it('deve logar informações da requisição', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('🔧 API Request Interceptor:', {
        url: '/test',
        baseURL: 'http://localhost:8000/api/v1',
    ...
    it('deve tratar erros de requisição', () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith('❌ API Request Interceptor Error:', error);
  ...
  describe('Response Interceptor', () => {
    ...
    it('deve tratar erro 401 e redirecionar para login', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('❌ API: Token expirado/inválido, redirecionando para login...');
