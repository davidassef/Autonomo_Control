...
describe("CategoryService", () => {
  ...
  describe("getAll", () => {
    ...
    it("deve tratar erro de autenticação", async () => {
      ...
      await expect(categoryService.getAll("expense")).rejects.toEqual(
        mockError,
      );
    });
  });
  ...
  describe("getById", () => {
    ...
    const result = categoryService.getById("1");
  ...
  describe("update", () => {
    ...
    it("deve tratar erro quando categoria não encontrada para atualização", async () => {
      ...
      await expect(categoryService.update("999", updateData)).rejects.toEqual(
        mockError,
      );
    });
    ...
    it("deve tratar erro de validação na atualização", async () => {
      ...
      await expect(categoryService.update("1", { name: "" })).rejects.toEqual(
        mockError,
      );
    });
    ...
    it("deve tratar erro de nome duplicado na atualização", async () => {
      ...
      await expect(
        categoryService.update("1", { name: "Salary" }),
      ).rejects.toEqual(mockError);
    });
  });
    ...
    it("deve tratar erro de categoria em uso", async () => {
      const mockError = {
        response: {
          status: 400,
          data: {
            detail: "Cannot delete category that is being used by entries",
          },
        },
      };
  ...
  describe("integração entre métodos", () => {
    it("deve criar e buscar categoria", async () => {
      ...
      const fetched = categoryService.getById("6");
    ...
    it("deve atualizar e buscar categoria", async () => {
      ...
      const fetched = categoryService.getById("1");
  ...
  describe("tratamento de subcategorias", () => {
    it("deve criar categoria com múltiplas subcategorias", async () => {
      ...
      expect(result.subcategories).toEqual(
        categoryWithManySubcategories.subcategories,
      );
    });
